    ...
    return (
        ...
        >
            <div className="relative flex max-h-[90vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-surface shadow-2xl">
                ...
                <div className="relative flex flex-1 items-center justify-center overflow-auto bg-canvas p-4">
                    <div className="relative max-h-[70vh] w-full max-w-3xl overflow-hidden rounded-xl border border-hairline bg-black">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img src={imageUrl} alt={`Creative ${creativeIndex + 1} · ${ratioLabel}`} className="h-full w-full object-contain" />
