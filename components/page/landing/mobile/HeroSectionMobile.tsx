    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center text-left w-full px-4 pt-20 pb-2 h-auto shrink-0">
                ...
                {/* Inner Left-Aligned Group Anchored by Primary Headline Width */}
                <div className="inline-flex flex-col items-start space-y-3 max-w-full">
                    ...
                    <h1 className="relative leading-[0.88] flex flex-col items-start select-none">
                        ...
                        <div className="relative mt-1 inline-block">
                            <div className="relative overflow-visible">
                                ...
                                <div
                                    className="absolute top-[48%] left-[-5%] w-[110%] h-[4px] bg-[#c21a2e] -rotate-[5.1deg] transform -translate-y-1/2 z-10 mix-blend-screen [clip-path:polygon(0%_50%,2%_0%,98%_0%,100%_50%,98%_100%,2%_100%)]"
                                    style={{ filter: 'drop-shadow(0 0 14px rgba(194,26,46,0.95))' }}
                                ></div>
                            </div>
                        </div>
                    </h1>
            ...
            {/* Standalone Center Floating CTA Island (Middle Zone Between Typography & 3D Video Cards) */}
            <div className="w-full flex items-center justify-center my-auto py-1 shrink-0">
                <button
                    onClick={onClickGetStarted}
                    className="group h-10 px-6 bg-white text-black rounded-full font-bold text-xs xs:text-sm flex items-center justify-center gap-2.5 active:scale-95 transition-all shadow-[0_0_35px_-5px_rgba(255,255,255,0.45)] hover:scale-105 hover:bg-zinc-200"
                >
