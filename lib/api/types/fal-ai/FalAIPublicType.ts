// 공통 타입 정의
import {MergeAudioVideoRequest, MergeVideosRequest} from "@/lib/api/types/fal-ai/FalAIRequest";
import {MergeAudioVideoResponse, MergeVideosResponse} from "@/lib/api/types/fal-ai/FalAIResponse";
